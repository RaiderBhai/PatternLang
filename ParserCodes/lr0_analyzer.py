...
Simplest LR parser - no lookahead symbols in items
"""
...
class LR0Analyzer:
    ...
    def generate_excel(self, filename='lr0_analysis.xlsx'):
...
def main():
    ...
    if analyzer.is_lr0():
        ...
        print("\nLR(0) is the simplest LR parser (no lookahead).")
    else:
        ...
        print("\n💡 Suggestion: Try SLR(1) or LR(1) parser for this grammar.")
